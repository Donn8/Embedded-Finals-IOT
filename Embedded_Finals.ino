...
// Define the Analog Pin of the Soil Moisture Sensor
#define soilMoisturePin A0

// Defines the Digital Pin of the "On Board LED".
#define ON_Board_LED 15 
...
const char* ssid = "Csm_141672";
const char* password = "Fawkner@1623";
//======================================== 
...
//========================================Variables for Soil Moisture sensor data.
int send_SoilM;
//========================================
...
void get_sensor_data() {
  ...
  //Read Soil Moisture
  send_SoilM = analogRead(soilMoisturePin);
  send_SoilM = map(send_SoilM, 1023, 400, 0, 100);
...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    postData += "&soilmoisture=" + String(send_SoilM);
    ...
    http.begin(client,"http://192.168.1.2/Embedded_Finals/updateDHT22data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
