<?php
  ...
  if (!empty($_POST)) {
    ...
    $q = $pdo->prepare($sql);
    $q->execute(array($temperature,$humidity,$soilmoisture,$status_read_sensor_dht22,$tm,$dt,$id));
    Database::disconnect();
    //........................................ 
    ...
    // This table is operated with the "INSERT" command, so this table will contain many rows.
		...
		$q = $pdo->prepare($sql);
		$q->execute(array($id_key,$board,$temperature,$humidity,$soilmoisture,$status_read_sensor_dht22,$led_01,$led_02,$tm,$dt));
    //::::::::
