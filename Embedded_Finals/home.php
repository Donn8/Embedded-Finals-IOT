...
<html>
  ...
  <body>
    ...
    <div class="content">
      <div class="cards">
        ...
        <div class="card">
          ...
          <p class="soilmoistureColor"><span class="reading"><span id="ESP32_01_SoilM"></span> &percnt;</span></p>
		  
          <!-- *********************************************************************** -->
          
          <p class="statusreadColor"><span>Status Read Sensor DHT22 : </span><span id="ESP32_01_Status_Read_DHT11"></span></p>
        </div>
        <!-- ======================================================================================================= -->
    ...
    <script>
	  ...
	  document.getElementById("ESP32_01_SoilM").innerHTML = "NN";
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            ...
            if (myObj.id == "esp8266_01") {
			  ...
			  document.getElementById("ESP32_01_SoilM").innerHTML = myObj.soilmoisture;
              document.getElementById("ESP32_01_Status_Read_DHT11").innerHTML = myObj.status_read_sensor_dht22;
