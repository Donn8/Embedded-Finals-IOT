...
<html>
  <head>
    <title>Embedded System Finals</title>
  ...
  <body>
      ...
      <div class="cards">
        ...
        <div class="card">
          ...
          <p class="humidityColor"><span class="reading"><span id="ESP8266_01_Humd"></span> &percnt;</span></p>
		      <h4 class="soilmoistureColor"><i class="fas fa-tint"></i> SOIL MOISTURE</h4>
          <p class="soilmoistureColor"><span class="reading"><span id="ESP8266_01_SoilM"></span> &percnt;</span></p>
		  
          <!-- *********************************************************************** -->
          
          <p class="statusreadColor"><span>Status Read Sensor DHT22 : </span><span id="ESP8266_01_Status_Read_DHT22"></span></p>
        </div>
        <!-- ======================================================================================================= -->
    ...
    <script>
      ...
      document.getElementById("ESP8266_01_Humd").innerHTML = "NN";
	    document.getElementById("ESP8266_01_SoilM").innerHTML = "NN";
      document.getElementById("ESP8266_01_Status_Read_DHT22").innerHTML = "NN";
          ...
          if (this.readyState == 4 && this.status == 200) {
            ...
            if (myObj.id == "esp8266_01") {
              ...
              document.getElementById("ESP8266_01_Humd").innerHTML = myObj.humidity;
			        document.getElementById("ESP8266_01_SoilM").innerHTML = myObj.soilmoisture;
              document.getElementById("ESP8266_01_Status_Read_DHT22").innerHTML = myObj.status_read_sensor_dht22;
